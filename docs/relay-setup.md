...
export SCRIPTUM_RELAY_HOST="0.0.0.0"
export SCRIPTUM_RELAY_PORT="8080"
export SCRIPTUM_RELAY_WS_BASE_URL="ws://localhost:8080"
export SCRIPTUM_RELAY_SHARE_LINK_BASE_URL="http://localhost:3000/share"
```
